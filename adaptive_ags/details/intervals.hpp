#ifndef ADAPRIVE_AGS_DETAILS_INTERVALS_HPP_
#define ADAPRIVE_AGS_DETAILS_INTERVALS_HPP_
...
template<size_t SIZE = 200>
class StaticIntervalSet {
public:
  explicit StaticIntervalSet(scalar_t reliability)
      : n_(0), t_(0), m_(0),
        r_(reliability),
        min_z_(utils::infty()) {
...
using IntervalSet = StaticIntervalSet<>;
